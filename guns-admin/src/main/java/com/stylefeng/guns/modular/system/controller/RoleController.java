...
public class RoleController extends BaseController {
     ...
     * 跳转到添加角色
     */
    @ApiOperation("跳转到添加角色")
    @RequestMapping(value = "/role_add",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     * 跳转到修改角色
     */
    @ApiOperation("跳转到修改角色")
    @Permission
    @RequestMapping(value = "/role_edit/{roleId}",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     * 跳转到角色分配
     */
    @ApiOperation("跳转到角色分配")
    @Permission
    @RequestMapping(value = "/role_assign/{roleId}",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     */
    @ApiOperation("查看角色")
    @RequestMapping(value = "/view/{roleId}",method ={RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
     ...
     */
    @ApiOperation("配置权限")
    @RequestMapping(value = "/setAuthority",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     */
    @ApiOperation("获取角色列表")
    @RequestMapping(value = "/roleTreeList",method ={RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
     ...
     */
    @ApiOperation("获取角色列表")
    @RequestMapping(value = "/roleTreeListByUserId/{userId}",method ={RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
