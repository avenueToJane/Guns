...
public class DeptController extends BaseController {
     ...
     * 跳转到添加部门
     */
    @ApiOperation("跳转到添加部门")
    @RequestMapping(value = "/dept_add",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     * 跳转到修改部门
     */
    @ApiOperation("跳转到修改部门")
    @Permission
    @RequestMapping(value = "/dept_update/{deptId}",method ={RequestMethod.POST,RequestMethod.GET})
     ...
     */
    @ApiOperation("部门详情")
    @RequestMapping(value = "/detail/{deptId}",method ={RequestMethod.POST,RequestMethod.GET})
    @Permission
    @ResponseBody
